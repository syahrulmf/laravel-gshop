                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="address" cols="30" rows="3" class="form-control @error('address') is-invalid @enderror" required autocomplete="address" autofocus placeholder="Roadname/Postcode/City Etc," value="{{ old('address') }}"></textarea>
